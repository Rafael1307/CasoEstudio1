          ...
          <form class="col-md-12" method="post">
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <?php 
                $consulta = "SELECT * FROM clientecompra LEFT JOIN cliente ON clientecompra.cliente = cliente.CorreoC LEFT JOIN libros ON clientecompra.libro = libros.idLibro LEFT JOIN compras ON clientecompra.compra = compras.IdCompra WHERE clientecompra.cliente = '$clienteA'";
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $row['UnidadCompra'];?></td>
